...
// 监听主题变化
watch([theme, colorScheme], applyTheme);
...
<template>
    <div class="min-h-screen p-8 transition-colors duration-300" :style="{ background: 'var(--color-bg)' }">
        <!-- 主题切换器 -->
        <div
            class="fixed top-5 right-5 flex gap-3 z-50 p-3 rounded-lg border backdrop-blur-sm"
            :style="{
        ...
        <div class="max-w-4xl mx-auto">
            <h1 class="text-3xl font-bold mb-2" :style="{ color: 'var(--color-primary)' }">
                Plain UI - Vue + TailwindCSS + TypeScript
            </h1>
            ...
            <!-- PButton Section -->
            <section
                class="mb-12 p-6 rounded-lg shadow-sm border"
                :style="{
                    backgroundColor: 'var(--color-bg)',
                    borderColor: 'var(--color-border)',
                }">
                <h2 class="text-xl font-semibold mb-4" :style="{ color: 'var(--color-primary)' }">PButton 按钮</h2>
                <div class="space-y-4">
            ...
            <section
                ...
                <h2 class="text-xl font-semibold mb-4" :style="{ color: 'var(--color-primary)' }">PCheckBox 复选框</h2>
                <div class="space-y-4">
            ...
            <section
                ...
                <h2 class="text-xl font-semibold mb-4" :style="{ color: 'var(--color-primary)' }">PTextBox 输入框</h2>
            ...
            <section
                ...
                <h2 class="text-xl font-semibold mb-4" :style="{ color: 'var(--color-primary)' }">PSlider 滑块</h2>
                <div class="space-y-6 max-w-md">
                    <div>
                        <label class="text-sm mb-2 block" :style="{ color: 'var(--color-text-secondary)' }">
                            基础滑块: {{ sliderValue }}
                        </label>
                    ...
                    <div>
                        <label class="text-sm mb-2 block" :style="{ color: 'var(--color-text-secondary)' }"> 步长 10 </label>
                        <PSlider :Value="sliderValue" :Min="0" :Max="100" :Step="10" />
                    </div>
                    <div>
                        <label class="text-sm mb-2 block" :style="{ color: 'var(--color-text-secondary)' }"> 禁用状态 </label>
            ...
            <section
                ...
                <h2 class="text-xl font-semibold mb-4" :style="{ color: 'var(--color-primary)' }">PRadioButton 单选按钮</h2>
                <div class="space-y-4">
                    <div class="flex gap-4 flex-wrap">
                        <PRadioButton
                            Text="选项一"
            ...
            <section
                ...
                <h2 class="text-xl font-semibold mb-4" :style="{ color: 'var(--color-primary)' }">PIconButton 图标按钮</h2>
                <div class="space-y-4">
            ...
            <section
                ...
                <h2 class="text-xl font-semibold mb-4" :style="{ color: 'var(--color-primary)' }">PCard 卡片</h2>
                <div class="space-y-4 max-w-md">
                    <PCard Title="普通卡片">
            ...
            <section
                ...
                <h2 class="text-xl font-semibold mb-4" :style="{ color: 'var(--color-primary)' }">PComboBox 下拉框</h2>
                <div class="space-y-4 max-w-md">
                    <div>
                        <label class="text-sm mb-2 block" :style="{ color: 'var(--color-text-secondary)' }"> 基础下拉框 </label>
                        <PComboBox
                            :Items="COMBO_OPTIONS"
                            :Text="comboValue"
                            HintText="请选择一个选项" />
            ...
            <section
                ...
                <h2 class="text-xl font-semibold mb-4" :style="{ color: 'var(--color-primary)' }">PExtraButton 扩展按钮</h2>
                <div class="space-y-4">
                    <div class="flex gap-4 items-center">
            ...
            <section
                ...
                <h2 class="text-xl font-semibold mb-4" :style="{ color: 'var(--color-primary)' }">
                    PExtraTextButton 扩展文本按钮
                </h2>
                <div class="flex gap-4 flex-wrap">
            ...
            <section
                ...
                <h2 class="text-xl font-semibold mb-4" :style="{ color: 'var(--color-primary)' }">PHint 提示</h2>
            ...
            <section
                ...
                <h2 class="text-xl font-semibold mb-4" :style="{ color: 'var(--color-primary)' }">
                    PIconTextButton 图标文本按钮
                </h2>
                <div class="flex gap-4 flex-wrap p-4 rounded-lg" :style="{ backgroundColor: 'var(--color-primary-light)' }">
            ...
            <section
                ...
                <h2 class="text-xl font-semibold mb-4" :style="{ color: 'var(--color-primary)' }">PListItem 列表项</h2>
            ...
            <section
                ...
                <h2 class="text-xl font-semibold mb-4" :style="{ color: 'var(--color-primary)' }">PLoading 加载</h2>
            ...
            <section
                ...
                <h2 class="text-xl font-semibold mb-4" :style="{ color: 'var(--color-primary)' }">PSearchBox 搜索框</h2>
                <div class="space-y-4 max-w-md">
                    <PSearchBox
                        Hint="搜索..."
                        :Text="searchValue" />
            ...
            <section
                ...
                <h2 class="text-xl font-semibold mb-4" :style="{ color: 'var(--color-primary)' }">组合使用示例</h2>
                <PCard Title="搜索卡片">
                    <div class="space-y-4">
