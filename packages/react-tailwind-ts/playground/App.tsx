...
function App() {
    ...
    const [checkBoxChecked, setCheckBoxChecked] = useState<boolean | null>(false);
    ...
    const [loadingStatus, setLoadingStatus] = useState<PLoadingState>("loading");
    const [searchValue, setSearchValue] = useState("");
    const [hintType, setHintType] = useState<PHintTheme>("Blue");

    return (
        <div className="min-h-screen bg-linear-to-br from-blue-50 to-white p-8">
            <div className="max-w-4xl mx-auto">
                <h1 className="text-3xl font-bold text-blue-500 mb-8">Plain UI - React Components</h1>

                {/* PButton Section */}
                <section className="mb-12 p-6 bg-white/70 rounded-lg shadow-sm border border-blue-200">
                    <h2 className="text-xl font-semibold text-blue-400 mb-4">PButton 按钮</h2>
                ...
                {/* PCheckBox Section */}
                <section className="mb-12 p-6 bg-white/70 rounded-lg shadow-sm border border-blue-200">
                    <h2 className="text-xl font-semibold text-blue-400 mb-4">PCheckBox 复选框</h2>
                    <div className="space-y-4">
                ...
                {/* PTextBox Section */}
                <section className="mb-12 p-6 bg-white/70 rounded-lg shadow-sm border border-blue-200">
                    <h2 className="text-xl font-semibold text-blue-400 mb-4">PTextBox 输入框</h2>
                ...
                {/* PSlider Section */}
                <section className="mb-12 p-6 bg-white/70 rounded-lg shadow-sm border border-blue-200">
                    <h2 className="text-xl font-semibold text-blue-400 mb-4">PSlider 滑块</h2>
                    <div className="space-y-6 max-w-md">
                        <div>
                            <label className="text-sm text-blue-400 mb-2 block">基础滑块: {sliderValue}</label>
                            <PSlider Value={sliderValue} onChange={setSliderValue} Min={0} Max={100} />
                        </div>
                        <div>
                            <label className="text-sm text-blue-400 mb-2 block">带格式化提示</label>
                            <PSlider
                                Value={sliderValue}
                        ...
                        <div>
                            <label className="text-sm text-blue-400 mb-2 block">步长 10</label>
                            <PSlider Value={sliderValue} onChange={setSliderValue} Min={0} Max={100} Step={10} />
                        </div>
                        <div>
                            <label className="text-sm text-blue-400 mb-2 block">禁用状态</label>
                ...
                <section className="mb-12 p-6 bg-white/70 rounded-lg shadow-sm border border-blue-200">
                    <h2 className="text-xl font-semibold text-blue-400 mb-4">PRadioButton 单选按钮</h2>
                    <div className="space-y-4">
                        <div className="flex gap-4 flex-wrap">
                            <PRadioButton
                                Text="选项一"
                ...
                {/* PIconButton Section */}
                <section className="mb-12 p-6 bg-white/70 rounded-lg shadow-sm border border-blue-200">
                    <h2 className="text-xl font-semibold text-blue-400 mb-4">PIconButton 图标按钮</h2>
                    <div className="space-y-4">
                ...
                {/* PCard Section */}
                <section className="mb-12 p-6 bg-white/70 rounded-lg shadow-sm border border-blue-200">
                    <h2 className="text-xl font-semibold text-blue-400 mb-4">PCard 卡片</h2>
                    <div className="space-y-4 max-w-md">
                        <PCard Title="普通卡片">
                            <p className="text-[13px] text-gray-600">这是卡片的内容区域，可以放置任何内容。</p>
                        </PCard>

                        <PCard Title="可折叠卡片" CanSwap IsSwapped={cardSwapped} onSwap={setCardSwapped}>
                            <div className="space-y-2">
                                <p className="text-[13px] text-gray-600">点击标题栏可以折叠/展开卡片。</p>
                                <PButton Text="卡片内的按钮" />
                            </div>
                        </PCard>

                        <PCard Title="禁用动画的卡片" HasMouseAnimation={false}>
                            <p className="text-[13px] text-gray-600">这个卡片禁用了鼠标悬停动画效果。</p>
                        </PCard>
                    </div>
                </section>
                ...
                {/* PComboBox Section */}
                <section className="mb-12 p-6 bg-white/70 rounded-lg shadow-sm border border-blue-200">
                    <h2 className="text-xl font-semibold text-blue-400 mb-4">PComboBox 下拉框</h2>
                    <div className="space-y-4 max-w-md">
                        <div>
                            <label className="text-sm text-blue-400 mb-2 block">基础下拉框</label>
                            <PComboBox
                                Items={COMBO_OPTIONS}
                                Text={comboValue}
                        ...
                        <div>
                            <label className="text-sm text-blue-400 mb-2 block">可编辑下拉框</label>
                            <PComboBox Items={COMBO_OPTIONS} IsEditable HintText="输入或选择" />
                        </div>
                        <div>
                            <label className="text-sm text-blue-400 mb-2 block">禁用状态</label>
                            <PComboBox Items={COMBO_OPTIONS} HintText="禁用状态" />
                        </div>
                    </div>
                </section>
                ...
                <section className="mb-12 p-6 bg-white/70 rounded-lg shadow-sm border border-blue-200">
                    <h2 className="text-xl font-semibold text-blue-400 mb-4">PExtraButton 扩展按钮</h2>
                    <div className="space-y-4">
                        <div className="flex gap-4 items-center">
                        ...
                        <div className="flex items-center gap-4">
                            <PSlider
                                ...
                                className="w-48"
                            />
                            <span className="text-sm text-blue-400">进度: {extraButtonProgress}%</span>
                        </div>
                    </div>
                </section>
                ...
                <section className="mb-12 p-6 bg-white/70 rounded-lg shadow-sm border border-blue-200">
                    <h2 className="text-xl font-semibold text-blue-400 mb-4">PExtraTextButton 扩展文本按钮</h2>
                    <div className="flex gap-4 flex-wrap">
                ...
                {/* PHint Section */}
                <section className="mb-12 p-6 bg-white/70 rounded-lg shadow-sm border border-blue-200">
                    <h2 className="text-xl font-semibold text-blue-400 mb-4">PHint 提示</h2>
                ...
                <section className="mb-12 p-6 bg-white/70 rounded-lg shadow-sm border border-blue-200">
                    <h2 className="text-xl font-semibold text-blue-400 mb-4">PIconTextButton 图标文本按钮</h2>
                    <div className="flex gap-4 flex-wrap bg-blue-400 p-4 rounded-lg">
                ...
                {/* PListItem Section */}
                <section className="mb-12 p-6 bg-white/70 rounded-lg shadow-sm border border-blue-200">
                    <h2 className="text-xl font-semibold text-blue-400 mb-4">PListItem 列表项</h2>
                ...
                {/* PLoading Section */}
                <section className="mb-12 p-6 bg-white/70 rounded-lg shadow-sm border border-blue-200">
                    <h2 className="text-xl font-semibold text-blue-400 mb-4">PLoading 加载</h2>
                ...
                {/* PSearchBox Section */}
                <section className="mb-12 p-6 bg-white/70 rounded-lg shadow-sm border border-blue-200">
                    <h2 className="text-xl font-semibold text-blue-400 mb-4">PSearchBox 搜索框</h2>
                    <div className="space-y-4 max-w-md">
                        <PSearchBox
                            Hint="搜索..."
                            Text={searchValue}
                ...
                {/* 组合使用示例 */}
                <section className="mb-12 p-6 bg-white/70 rounded-lg shadow-sm border border-blue-200">
                    <h2 className="text-xl font-semibold text-blue-400 mb-4">组合使用示例</h2>
                    <PCard Title="搜索卡片">
                        <div className="space-y-4">
                            <PSearchBox Hint="搜索内容..." SearchButtonVisibility={true} className="w-full" />
