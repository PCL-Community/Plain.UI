...
const ThemeSwitcher = ({ currentTheme, currentColor, onThemeChange, onColorChange }: ThemeSwitcherProps) => {
    return (
        <div className="fixed top-5 right-5 flex gap-3 z-50 p-3 rounded-lg border backdrop-blur-sm"
             style={{
            ...
            <button
                ...
                className="w-9 h-9 rounded-full flex items-center justify-center border cursor-pointer transition-all duration-200"
                style={{
                    borderColor: "var(--color-border)",
                    backgroundColor: "var(--color-bg)",
    ...
    return (
        <div className="min-h-screen p-8 transition-colors duration-300"
            ...
            <div className="max-w-4xl mx-auto">
                ...
                {/* PButton Section */}
                <section className="mb-12 p-6 rounded-lg shadow-sm border"
                         style={{
                             backgroundColor: "var(--color-bg)",
                             borderColor: "var(--color-border)",
                         }}>
