...
// 导出类型定义
export type { PButtonColorState, PButtonProps } from "./components/PButton.vue";
...
export type { PComboBoxItem, PComboBoxProps } from "./components/PComboBox.vue";
...
export type { PHintTheme, PHintProps } from "./components/PHint.vue";
...
export type { PLoadingState, PLoadingProps } from "./components/PLoading.vue";
